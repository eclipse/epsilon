...
public class CascadeUpdatesCellsNotManyToManyPropertySetterTest {
	...
	public static Collection<Object[]> models() throws Exception {
		...
		String CONFIG = "resources/propertysetter/CascadeUpdatesCellsNotManyToManyPropertySetterTest.xml";
		return TestModelFactory.getModelsToTest("", PATH_TO_FILE, CONFIG, "PropertySetterTest");
	}

	@Test
	public void testCellsNotManyToMany() throws Exception {
		...
		assertTrue(model.getAllOfType("Sheet3").size() == 4);
		model.getWorksheetByType("Sheet3").removeRow(rowSheet3_req3);
		assertTrue(model.getAllOfType("Sheet3").size() == 3);
		...
		setter.invoke(rowSheet3, columnSheet3.getPrefixedIndex(), "REQ4", null, null);

		assertTrue(rowSheet3.getAllVisibleCellValuesAsIs(columnSheet3).size() == 1);
		assertTrue(rowSheet3.getVisibleCellValue(columnSheet3).equals("REQ4"));
		assertTrue(rowSheet3_req1.getAllVisibleCellValuesAsIs(columnSheet3).size() == 1);
		assertTrue(rowSheet3_req1.getVisibleCellValue(columnSheet3).equals("REQ1"));
		assertTrue(rowSheet3_req2.getAllVisibleCellValuesAsIs(columnSheet3).size() == 1);
		assertTrue(rowSheet3_req2.getVisibleCellValue(columnSheet3).equals("REQ2"));
	...
	@Test
	public void testCellsNotManyToMany_CascadeToSecondLevel() throws Exception {
		SharedTestMethods.clearWorksheet(model, "Sheet1");
		SharedTestMethods.clearWorksheet(model, "Sheet2");
		SharedTestMethods.clearWorksheet(model, "Sheet3");
		...
		SpreadsheetRow rowSheet3 = SharedTestMethods.writeRow(model, "Sheet3", "c_1", "1", col, "REQ3, REQ2, REQ1");
		assertTrue(rowSheet3.getVisibleCellValue(columnSheet3).equals("REQ3, REQ2, REQ1"));
		assertTrue(rowSheet3.getAllVisibleCellValuesAsIs(columnSheet3).size() == 3);
		assertTrue(rowSheet3.getVisibleCellValue(model.getWorksheetByType("Sheet3").getColumn("c_1")).equals("1"));
		...
		SpreadsheetRow rowSheet2 = SharedTestMethods.writeRow(model, "Sheet2", "c_1", "4", col, rowSheet3);
		assertTrue(rowSheet2.getVisibleCellValue(columnSheet2).equals("REQ3"));
		assertTrue(rowSheet2.getAllVisibleCellValuesAsIs(columnSheet2).size() == 1);
		assertTrue(rowSheet2.getVisibleCellValue(model.getWorksheetByType("Sheet2").getColumn("c_1")).equals("4"));
		...
		SpreadsheetRow rowSheet1 = SharedTestMethods.writeRow(model, "Sheet1", "c_1", "1", col, rowSheet2);
		assertTrue(rowSheet1.getVisibleCellValue(columnSheet1).equals("REQ3"));
		assertTrue(rowSheet1.getAllVisibleCellValuesAsIs(columnSheet1).size() == 1);
		assertTrue(rowSheet1.getVisibleCellValue(model.getWorksheetByType("Sheet1").getColumn("c_1")).equals("1"));
		...
		assertTrue(rowSheet2_req3.getAllVisibleCellValuesAsIs(columnSheet2).size() == 0);
		assertTrue(rowSheet2_req3.getVisibleCellValue(columnSheet2).equals(""));
		assertTrue(rowSheet2.getAllVisibleCellValuesAsIs(columnSheet2).size() == 0);
		assertTrue(rowSheet2.getVisibleCellValue(columnSheet2).equals(""));
		assertTrue(rowSheet1.getAllVisibleCellValuesAsIs(columnSheet1).size() == 0);
		assertTrue(rowSheet1.getVisibleCellValue(columnSheet1).equals(""));
	}
