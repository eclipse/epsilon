...
public class UnrecognisedFeature extends HutnModelValidationTest {
	...
	public static void validateModel() throws Exception {
		problems = modelValidationTest(createSpec("families", createPackageObject(createClassObject("The Smiths",
		                                                                                "Family", 
		                                                                                createAttributeSlot("previousAddress", "123 Main Street")))));
	}
	...
	@Test
	public void reasonShouldBeUnrecognisedFeature() {
		assertEquals("Unrecognised feature: previousAddress", problems.get(0).getReason());
	}
}
