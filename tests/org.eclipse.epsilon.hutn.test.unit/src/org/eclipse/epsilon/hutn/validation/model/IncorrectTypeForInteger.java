 ...
 ******************************************************************************
 *
 * $Id: IncorrectTypeForInteger.java,v 1.1 2008/08/07 14:51:11 louis Exp $
 */
...
public class IncorrectTypeForInteger extends HutnModelValidationTest {
	...
	public static void validateModel() throws Exception {
		problems = modelValidationTest(createSpec("families", createPackageObject(createClassObject("The Smiths",
		                                                                                "Family",
		                                                                                createAttributeSlot("numberOfChildren", "NaN")))));
	}
	...
	public void reasonShouldBeIncorrectType() {
		assertEquals("Expected EInt for: numberOfChildren", problems.get(0).getReason());
	}
}
