...
public class ContainmentForReference extends HutnModelValidationTest {
	...
	public static void validateModel() throws Exception {
		problems = modelValidationTest(createSpec("families", createPackageObject(createClassObject("The Smiths",
		                                                                                            "Family", 
		                                                                                            createContainmentSlot("pets", createClassObject("Fido", "Pet"))))));
	}
	...
	@Test
	public void reasonShouldBeContainmentForReference() {
		assertEquals("A contained object was specified for the non-containment feature Family#pets.", problems.get(0).getReason());
	}
}
