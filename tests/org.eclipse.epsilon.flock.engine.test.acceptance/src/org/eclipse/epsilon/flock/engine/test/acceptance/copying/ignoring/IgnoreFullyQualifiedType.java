...
public class IgnoreFullyQualifiedType extends FlockAcceptanceTest {
	
	private static final String strategy = "migrate families::Family ignoring numberOfChildren";
