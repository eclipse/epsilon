...
public class ExtendAndRetype extends Strong2StrongMigrationAcceptanceTest {

	private static final String strategy = "migrate Pet {" +
	                                       "  migrated.male := true;" +
	                                       "}" +
	                                       "migrate Dog to Pet extends Pet\n";
	...
	public static void setup() throws Throwable {
		...
		migrated.setVariable("dogThatBecameAPet", "Pet.all.selectOne(p|p.name='Lassie')");
	}
	
	@Test
	public void petShouldHaveCorrectGender() {
		migrated.assertTrue("pet.male");
	}
	
	@Test
	public void dogThatBecameAPetShouldHaveCorrectGender() {
		migrated.assertTrue("dogThatBecameAPet.male");
	}
}
