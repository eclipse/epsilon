...
public class FamiliesFactoryImpl extends EFactoryImpl implements FamiliesFactory {
	...
	public static FamiliesFactory init() {
		try {
			FamiliesFactory theFamiliesFactory = (FamiliesFactory)EPackage.Registry.INSTANCE.getEFactory("families"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case FamiliesPackage.PET: return createPet();
			...
			case FamiliesPackage.BIKE: return createBike();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case FamiliesPackage.DOG_BREED:
				return createDogBreedFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case FamiliesPackage.DOG_BREED:
				return convertDogBreedToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public DogBreed createDogBreedFromString(EDataType eDataType, String initialValue) {
		DogBreed result = DogBreed.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertDogBreedToString(EDataType eDataType, Object instanceValue) {
