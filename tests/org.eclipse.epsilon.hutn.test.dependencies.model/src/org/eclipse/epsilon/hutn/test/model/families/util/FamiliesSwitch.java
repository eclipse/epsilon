...
public class FamiliesSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FamiliesPackage.NAMED_ELEMENT: {
			...
			case FamiliesPackage.PET: {
				Pet pet = (Pet)theEObject;
				T result = casePet(pet);
				if (result == null) result = caseNamedElement(pet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FamiliesPackage.PERSON: {
