 ...
 * ******************************************************************************
 *
 * $Id: InfixAssociation.java,v 1.1 2008/08/14 12:37:30 louis Exp $
 */
...
public class InfixAssociation extends HutnAcceptanceTest {
	...
	public static void executeHutn() throws Exception {
		final String hutn = "@Spec {"                                      +
                            ...
                            "	}"                                         +
                            ""                                             +
                            "   Family \"The Smiths\" pets Pet \"Fido\";"  +
                            "   Family \"The Smiths\" pets Pet \"Tilly\";" +
                            "}";
