...
public class RulesAreTyped extends EgxAcceptanceTest {
	...
	private static final String model = "Families { Person { name: \"John\" } Family { name: \"Smiths\" } }";
	
	@Test
	public void egxRuleAppliesToModelElement() throws Exception {
		File egxFile = FileUtil.getFile("simple.egx", RulesAreTyped.class);
		File eglFile = FileUtil.getFile("hello.egl", RulesAreTyped.class);
		...
		File outFile = FileUtil.getFile("out.txt", RulesAreTyped.class);
