...
@RunWith(Suite.class)
@SuiteClasses({TestMigration.class, MigrationStrategyLoaderTest.class,
               MigrationStrategyTest.class,
               MigrationRuleGuardTest.class, MigrationRuleExecuteTest.class})
