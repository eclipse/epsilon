...
import rcpapp.diagram.edit.policies.RcpappTextSelectionEditPolicy;
import rcpapp.diagram.part.RcpappVisualIDRegistry;
import rcpapp.diagram.providers.RcpappElementTypes;
import rcpapp.diagram.providers.RcpappParserProvider;
...
public class ComponentNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new RcpappTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return RcpappElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RcpappParserProvider
					.getParser(
							RcpappElementTypes.Component_2001,
							getParserElement(),
							RcpappVisualIDRegistry
									.getType(rcpapp.diagram.edit.parts.ComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					RcpappEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
