 ...
 * @generated
 */
public class RcpappInitDiagramFileAction implements
	...
	public void run(IAction action) {
		TransactionalEditingDomain editingDomain = GMFEditingDomainFactory.INSTANCE
				.createEditingDomain();
		Resource resource = RcpappDiagramEditorUtil.openModel(getShell(),
		...
		Wizard wizard = new RcpappNewDiagramFileWizard(resource.getURI(),
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ModelEditPart.MODEL_ID));
		RcpappDiagramEditorUtil
