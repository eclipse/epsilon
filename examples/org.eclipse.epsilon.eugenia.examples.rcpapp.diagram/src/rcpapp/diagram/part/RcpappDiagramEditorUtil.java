 ...
 * @generated
 */
public class RcpappDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.RcpappDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.RcpappDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = RcpappDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor.beginTask(
				Messages.RcpappDiagramEditorUtil_CreateDiagramProgressTask, 3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.RcpappDiagramEditorUtil_CreateDiagramCommandLabel,
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					modelResource
							.save(rcpapp.diagram.part.RcpappDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(rcpapp.diagram.part.RcpappDiagramEditorUtil
									.getSaveOptions());
	...
	private static Model createInitialModel() {
		return RcpappFactory.eINSTANCE.createModel();
	}
