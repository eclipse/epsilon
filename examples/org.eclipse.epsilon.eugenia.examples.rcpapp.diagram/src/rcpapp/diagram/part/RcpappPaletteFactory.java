 ...
 * @generated
 */
public class RcpappPaletteFactory {
	...
	private ToolEntry createComponent1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections.singletonList(RcpappElementTypes.Component_2001));
		entry.setId("createComponent1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(RcpappElementTypes
				.getImageDescriptor(RcpappElementTypes.Component_2001));
