...
import widgets.diagram.edit.policies.WidgetsTextSelectionEditPolicy;
 ...
 * @generated
 */
public class WidgetNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public WidgetNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new WidgetsTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new SystemEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WidgetsParserProvider
					.getParser(
							WidgetsElementTypes.Widget_2001,
							getParserElement(),
							WidgetsVisualIDRegistry
									.getType(widgets.diagram.edit.parts.WidgetNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					WidgetsEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
