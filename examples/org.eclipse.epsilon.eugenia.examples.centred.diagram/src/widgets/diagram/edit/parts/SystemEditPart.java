...
import widgets.diagram.edit.commands.WidgetsCreateShortcutDecorationsCommand;
import widgets.diagram.edit.policies.SystemCanonicalEditPolicy;
import widgets.diagram.edit.policies.SystemItemSemanticEditPolicy;
...
public class SystemEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Widgets"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						WidgetsVisualIDRegistry.TYPED_INSTANCE));
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new WidgetsCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
