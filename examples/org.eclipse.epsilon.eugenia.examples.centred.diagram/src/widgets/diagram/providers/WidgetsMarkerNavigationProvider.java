...
import widgets.diagram.part.WidgetsDiagramEditorUtil;

/**
 * @generated
 */
public class WidgetsMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = WidgetsDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			WidgetsDiagramEditorUtil.selectElementsInDiagram(editor,
