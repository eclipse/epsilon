 ...
 * @generated
 */
public class WidgetsInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new WidgetsNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SystemEditPart.MODEL_ID));
		WidgetsDiagramEditorUtil.runWizard(getShell(), wizard,
