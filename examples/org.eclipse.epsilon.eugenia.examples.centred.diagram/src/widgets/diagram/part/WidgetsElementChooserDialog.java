 ...
 * @generated
 */
public class WidgetsElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public WidgetsElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.WidgetsElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "widgets".equals(fileExtension); //$NON-NLS-1$
	}
