...
/**
 * This is the item provider adapter for a {@link filesystem.Shortcut} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Shortcut_target_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Shortcut_target_feature", "_UI_Shortcut_type"),
         FilesystemPackage.Literals.SHORTCUT__TARGET,
         true,
         false,
         true,
         null,
