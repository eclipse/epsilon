 ...
 * @generated
 */
public class PersonNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				FriendsVisualIDRegistry
						.getType(friends.diagram.edit.parts.PersonNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new FriendsParserProvider.HintAdapter(
					FriendsElementTypes.Person_1001, getParserElement(),
					parserHint);
	...
	protected IFigure createFigurePrim() {
		return new PersonLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PersonLabelFigure extends WrappingLabel {
