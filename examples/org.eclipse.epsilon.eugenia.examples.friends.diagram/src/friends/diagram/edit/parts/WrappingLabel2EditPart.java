...
public class WrappingLabel2EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				FriendsVisualIDRegistry
						.getType(friends.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new WorldEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FriendsParserProvider.getParser(
					FriendsElementTypes.PersonEnemyOf_4002, getParserElement(),
