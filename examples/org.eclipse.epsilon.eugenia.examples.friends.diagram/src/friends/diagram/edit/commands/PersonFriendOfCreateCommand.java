 ...
 * @generated
 */
public class PersonFriendOfCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PersonFriendOfCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return FriendsBaseItemSemanticEditPolicy.LinkConstraints
				.canCreatePersonFriendOf_3001(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getFriendOf().add(getTarget());
		}
