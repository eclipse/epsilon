 ...
 * @generated
 */
public class PersonEnemyOfReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PersonEnemyOfReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return FriendsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPersonEnemyOf_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return FriendsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPersonEnemyOf_4002(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getEnemyOf().remove(getOldTarget());
		getNewSource().getEnemyOf().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getEnemyOf().remove(getOldTarget());
		getOldSource().getEnemyOf().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
