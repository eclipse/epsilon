 ...
 * @generated
 */
public class PersonEnemyOfCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PersonEnemyOfCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return FriendsBaseItemSemanticEditPolicy.LinkConstraints
				.canCreatePersonEnemyOf_3002(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getEnemyOf().add(getTarget());
		}
