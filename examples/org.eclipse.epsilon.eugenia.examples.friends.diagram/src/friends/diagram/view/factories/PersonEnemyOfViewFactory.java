 ...
 * @generated
 */
public class PersonEnemyOfViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = FriendsVisualIDRegistry
		...
		getViewService().createNode(
				...
				FriendsVisualIDRegistry
						.getType(PersonEnemyOfExternalLabelEditPart.VISUAL_ID),
