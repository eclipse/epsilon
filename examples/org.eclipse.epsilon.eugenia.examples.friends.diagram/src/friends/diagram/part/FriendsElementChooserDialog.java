 ...
 * @generated
 */
public class FriendsElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public FriendsElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.FriendsElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "friends".equals(fileExtension); //$NON-NLS-1$
	}
