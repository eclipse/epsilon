...
import friends.diagram.providers.FriendsMarkerNavigationProvider;
import friends.diagram.providers.FriendsValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			if (FriendsDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		FriendsValidationProvider.runWithConstraints(txDomain, new Runnable() {
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			FriendsMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		FriendsMarkerNavigationProvider.addMarker(target, elementId, location,
