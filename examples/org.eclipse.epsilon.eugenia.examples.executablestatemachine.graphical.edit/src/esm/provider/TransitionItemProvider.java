...
/**
 * This is the item provider adapter for a {@link esm.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EsmPackage.Literals.TRANSITION__ACTION,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EsmPackage.Literals.TRANSITION__SOURCE,
         true,
         false,
         true,
         null,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EsmPackage.Literals.TRANSITION__TARGET,
         true,
         false,
         true,
         null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(EsmPackage.Literals.TRANSITION__ACTION_IMPL);
    }
    ...
    newChildDescriptors.add
      (createChildParameter
        (EsmPackage.Literals.TRANSITION__ACTION_IMPL,
         EsmFactory.eINSTANCE.createMachine()));

    newChildDescriptors.add
      (createChildParameter
        (EsmPackage.Literals.TRANSITION__ACTION_IMPL,
         EsmFactory.eINSTANCE.createState()));
