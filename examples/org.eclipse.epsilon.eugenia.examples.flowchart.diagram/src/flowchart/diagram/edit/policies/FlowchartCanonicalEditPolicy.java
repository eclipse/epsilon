 ...
 * @generated
 */
public class FlowchartCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FlowchartNodeDescriptor> childDescriptors = FlowchartDiagramUpdater
				.getFlowchart_1000SemanticChildren(viewObject);
		for (FlowchartNodeDescriptor d : childDescriptors) {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == SubflowEditPart.VISUAL_ID
				|| visualID == ActionEditPart.VISUAL_ID
				|| visualID == DecisionEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		for (Iterator<FlowchartNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			FlowchartNodeDescriptor next = descriptorsIterator.next();
			String hint = FlowchartVisualIDRegistry.getType(next.getVisualID());
		...
		for (FlowchartNodeDescriptor next : childDescriptors) {
			String hint = FlowchartVisualIDRegistry.getType(next.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<FlowchartLinkDescriptor> linkDescriptors = collectAllLinks(
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			for (Iterator<FlowchartLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				FlowchartLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<FlowchartLinkDescriptor> collectAllLinks(View view,
		...
		case ActionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(FlowchartDiagramUpdater
						.getAction_2004ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
	...
	private Collection<IAdaptable> createConnections(
			Collection<FlowchartLinkDescriptor> linkDescriptors,
			Map<EObject, View> domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (FlowchartLinkDescriptor nextLinkDescriptor : linkDescriptors) {
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
					...
					FlowchartVisualIDRegistry.getType(nextLinkDescriptor
