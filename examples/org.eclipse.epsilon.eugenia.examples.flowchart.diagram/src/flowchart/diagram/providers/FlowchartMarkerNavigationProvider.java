 ...
 * @generated
 */
public class FlowchartMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = FlowchartDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			FlowchartDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
