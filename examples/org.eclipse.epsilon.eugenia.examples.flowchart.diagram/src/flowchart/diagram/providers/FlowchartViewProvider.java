 ...
 * @generated
 */
public class FlowchartViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return FlowchartEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = FlowchartVisualIDRegistry.getNodeVisualID(op
					.getContainerView(), domainElement);
		} else {
			visualID = FlowchartVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				...
				if (!FlowchartEditPart.MODEL_ID
						.equals(FlowchartVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return SubflowEditPart.VISUAL_ID == visualID
				|| DecisionEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(FlowchartEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case SubflowEditPart.VISUAL_ID:
			return createSubflow_2001(domainElement, containerView, index,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (FlowchartVisualIDRegistry.getVisualID(elementTypeHint)) {
	 ...
	 * @generated
	 */
	public Node createSubflow_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FlowchartVisualIDRegistry
		...
		Node label5001 = createLabel(node, FlowchartVisualIDRegistry
	...
	public Node createDecision_2003(EObject domainElement, View containerView,
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities
				.RGBToInteger(fillRGB));
		Node label5003 = createLabel(node, FlowchartVisualIDRegistry
	...
	public Edge createTransition_4001(EObject domainElement,
		...
		edge.setType(FlowchartVisualIDRegistry
		...
		Node label6001 = createLabel(edge, FlowchartVisualIDRegistry
