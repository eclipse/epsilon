 ...
 * @generated
 */
public class FlowchartElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public FlowchartElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.FlowchartElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "flowchart".equals(fileExtension); //$NON-NLS-1$
	}
