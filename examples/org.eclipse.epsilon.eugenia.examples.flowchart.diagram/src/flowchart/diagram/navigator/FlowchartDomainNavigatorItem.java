	...
	static {
		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof flowchart.diagram.navigator.FlowchartDomainNavigatorItem) {
					flowchart.diagram.navigator.FlowchartDomainNavigatorItem domainNavigatorItem = (flowchart.diagram.navigator.FlowchartDomainNavigatorItem) adaptableObject;
		...
		}, flowchart.diagram.navigator.FlowchartDomainNavigatorItem.class);
	}
