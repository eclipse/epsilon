 ...
 * @generated
 */
public class FlowchartDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public FlowchartDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof FlowchartDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((FlowchartDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new FlowchartDomainNavigatorItem(
