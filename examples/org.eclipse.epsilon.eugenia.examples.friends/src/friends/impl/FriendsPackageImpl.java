...
public class FriendsPackageImpl extends EPackageImpl implements FriendsPackage {
	...
	public static FriendsPackage init() {
		...
		FriendsPackageImpl theFriendsPackage = (FriendsPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof FriendsPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new FriendsPackageImpl());
