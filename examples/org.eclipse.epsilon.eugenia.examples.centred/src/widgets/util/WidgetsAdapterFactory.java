...
public class WidgetsAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected WidgetsSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter caseSystem(widgets.System object)
      {
  ...
  /**
   * Creates a new adapter for an object of class '{@link widgets.System <em>System</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link widgets.Widget <em>Widget</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
