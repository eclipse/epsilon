 ...
 * @generated
 */
public class FeatureFeaturePluginsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return FedPackage.eINSTANCE.getFeature_Plugins();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<FedNodeDescriptor> childDescriptors = FedDiagramUpdater
				.getFeatureFeaturePluginsCompartment_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return Plugin2EditPart.VISUAL_ID == FedVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<FedNodeDescriptor> childDescriptors = FedDiagramUpdater
				.getFeatureFeaturePluginsCompartment_7001SemanticChildren((View) getHost()
						.getModel());
