 ...
 * @generated
 */
public class FeatureIncludesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FeatureIncludesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return FedBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistFeatureIncludes_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return FedBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistFeatureIncludes_4002(getOldSource(), getNewTarget());
	}
