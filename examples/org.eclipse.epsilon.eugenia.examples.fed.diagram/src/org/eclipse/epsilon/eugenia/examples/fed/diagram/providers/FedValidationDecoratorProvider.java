...
import org.eclipse.epsilon.eugenia.examples.fed.diagram.part.FedDiagramEditor;
 ...
 * @generated
 */
public class FedValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = FedDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof FedDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ConfigurationEditPart.MODEL_ID.equals(FedVisualIDRegistry
						.getModelID(view));
	}
