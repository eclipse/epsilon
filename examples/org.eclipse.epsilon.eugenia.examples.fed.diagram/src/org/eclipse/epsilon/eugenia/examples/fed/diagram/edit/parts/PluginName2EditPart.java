...
import org.eclipse.epsilon.eugenia.examples.fed.diagram.edit.policies.FedTextSelectionEditPolicy;
 ...
 * @generated
 */
public class PluginName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PluginName2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new FedTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new ConfigurationEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return FedElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FedParserProvider
					.getParser(
							FedElementTypes.Plugin_3001,
							getParserElement(),
							FedVisualIDRegistry
									.getType(org.eclipse.epsilon.eugenia.examples.fed.diagram.edit.parts.PluginName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					FedEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
