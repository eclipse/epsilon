 ...
 * @generated
 */
public class FedViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ConfigurationEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& FedVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = FedVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = FedVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!FedElementTypes.isKnownElementType(elementType)
		...
		return FeatureEditPart.VISUAL_ID == visualID
				|| PluginEditPart.VISUAL_ID == visualID
				|| Plugin2EditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = FedVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != FedVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = FedVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = FedVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case FeatureEditPart.VISUAL_ID:
		...
		case PluginEditPart.VISUAL_ID:
			return createPlugin_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case Plugin2EditPart.VISUAL_ID:
			return createPlugin_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (FedVisualIDRegistry.getVisualID(elementTypeHint)) {
		case FeatureDependsEditPart.VISUAL_ID:
			return createFeatureDepends_4001(containerView, index, persisted,
					preferencesHint);
		case FeatureIncludesEditPart.VISUAL_ID:
			return createFeatureIncludes_4002(containerView, index, persisted,
					preferencesHint);
		}
	...
	public Node createFeature_2001(EObject domainElement, View containerView,
		...
		node.setType(FedVisualIDRegistry.getType(FeatureEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createPlugin_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FedVisualIDRegistry.getType(PluginEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createPlugin_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FedVisualIDRegistry.getType(Plugin2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Edge createFeatureDepends_4001(View containerView, int index,
		...
		edge.setType(FedVisualIDRegistry
		...
		Node label6001 = createLabel(edge,
				FedVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createFeatureIncludes_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label6002 = createLabel(edge,
				FedVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
