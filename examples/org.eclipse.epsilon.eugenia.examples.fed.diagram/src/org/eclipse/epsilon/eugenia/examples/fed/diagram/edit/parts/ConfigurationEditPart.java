...
import org.eclipse.epsilon.eugenia.examples.fed.diagram.edit.commands.FedCreateShortcutDecorationsCommand;
import org.eclipse.epsilon.eugenia.examples.fed.diagram.edit.policies.ConfigurationCanonicalEditPolicy;
import org.eclipse.epsilon.eugenia.examples.fed.diagram.edit.policies.ConfigurationItemSemanticEditPolicy;
...
public class ConfigurationEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Fed"; //$NON-NLS-1$
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new FedCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
