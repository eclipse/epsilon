 ...
 * @generated
 */
public class FedElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public FedElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.FedElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "fed".equals(fileExtension); //$NON-NLS-1$
	}
