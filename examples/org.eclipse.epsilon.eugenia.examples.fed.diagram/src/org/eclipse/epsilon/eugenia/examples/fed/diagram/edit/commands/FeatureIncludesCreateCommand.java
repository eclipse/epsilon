 ...
 * @generated
 */
public class FeatureIncludesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FeatureIncludesCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return FedBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateFeatureIncludes_4002(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getIncludes().add(getTarget());
		}
