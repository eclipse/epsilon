...
public class WrappingLabel2EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				FedVisualIDRegistry
						.getType(org.eclipse.epsilon.eugenia.examples.fed.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new ConfigurationEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FedParserProvider.getParser(
					FedElementTypes.FeatureIncludes_4002, getParserElement(),
