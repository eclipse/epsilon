 ...
 * @generated
 */
public class PluginNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PluginNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = FedParserProvider
					.getParser(
							...
							getParserElement(),
							FedVisualIDRegistry
									.getType(org.eclipse.epsilon.eugenia.examples.fed.diagram.edit.parts.PluginNameEditPart.VISUAL_ID));
		}
		return parser;
	}
