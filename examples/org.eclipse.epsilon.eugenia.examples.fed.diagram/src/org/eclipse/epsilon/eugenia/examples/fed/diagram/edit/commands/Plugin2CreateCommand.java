 ...
 * @generated
 */
public class Plugin2CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public Plugin2CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Plugin newElement = FedFactory.eINSTANCE.createPlugin();

		Feature owner = (Feature) getElementToEdit();
		owner.getPlugins().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Plugin newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
