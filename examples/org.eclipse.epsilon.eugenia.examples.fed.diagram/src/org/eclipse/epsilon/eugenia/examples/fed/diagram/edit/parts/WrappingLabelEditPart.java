...
public class WrappingLabelEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				FedVisualIDRegistry
						.getType(org.eclipse.epsilon.eugenia.examples.fed.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FedParserProvider.getParser(
					FedElementTypes.FeatureDepends_4001, getParserElement(),
