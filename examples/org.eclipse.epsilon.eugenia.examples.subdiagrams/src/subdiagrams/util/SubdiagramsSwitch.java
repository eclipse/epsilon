 ...
 * @generated
 */
public class SubdiagramsSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case SubdiagramsPackage.PACKAGE:
      {
        subdiagrams.Package package_ = (subdiagrams.Package)theEObject;
        T result = casePackage(package_);
        if (result == null) result = casePackageableElement(package_);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case SubdiagramsPackage.PACKAGEABLE_ELEMENT:
      {
      ...
      case SubdiagramsPackage.CLAZZ:
      {
        Clazz clazz = (Clazz)theEObject;
        T result = caseClazz(clazz);
        if (result == null) result = casePackageableElement(clazz);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
  public T casePackage(subdiagrams.Package object)
  {
    return null;
  }
