 ...
 * 
 */
package people.diagram.edit.parts;
...
import people.diagram.edit.commands.PeopleCreateShortcutDecorationsCommand;
import people.diagram.edit.policies.ModelCanonicalEditPolicy;
import people.diagram.edit.policies.ModelItemSemanticEditPolicy;
...
public class ModelEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "People"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						PeopleVisualIDRegistry.TYPED_INSTANCE));
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new PeopleCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
