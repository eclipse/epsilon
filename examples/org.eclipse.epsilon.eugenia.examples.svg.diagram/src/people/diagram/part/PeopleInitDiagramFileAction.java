 ...
 * @generated
 */
public class PeopleInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new PeopleNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ModelEditPart.MODEL_ID));
		PeopleDiagramEditorUtil
