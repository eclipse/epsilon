 ...
 * @generated
 */
public class PeopleElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public PeopleElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.PeopleElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "people".equals(fileExtension); //$NON-NLS-1$
	}
