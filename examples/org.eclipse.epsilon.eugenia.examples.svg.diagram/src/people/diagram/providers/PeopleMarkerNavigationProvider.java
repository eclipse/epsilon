...
import people.diagram.part.PeopleDiagramEditorUtil;

/**
 * @generated
 */
public class PeopleMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = PeopleDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			PeopleDiagramEditorUtil.selectElementsInDiagram(editor,
