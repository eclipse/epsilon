 ...
 * @generated
 */
public class PeopleViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = PeopleVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = PeopleVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!PeopleElementTypes.isKnownElementType(elementType)
				...
				if (!ModelEditPart.MODEL_ID.equals(PeopleVisualIDRegistry
				...
				case PersonEditPart.VISUAL_ID:
					if (domainElement == null
							|| visualID != PeopleVisualIDRegistry
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = PeopleVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != PeopleVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = PeopleVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = PeopleVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case PersonEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (PeopleVisualIDRegistry.getVisualID(elementTypeHint)) {
		}
	...
	public Node createPerson_2001(EObject domainElement, View containerView,
		...
		node.setType(PeopleVisualIDRegistry.getType(PersonEditPart.VISUAL_ID));
