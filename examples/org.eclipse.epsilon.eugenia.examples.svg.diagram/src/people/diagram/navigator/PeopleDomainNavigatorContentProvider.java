 ...
 * @generated
 */
public class PeopleDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public PeopleDomainNavigatorContentProvider() {
		myAdapterFctoryContentProvier = new AdapterFactoryContentProvider(
				PeopleDiagramEditorPlugin.getInstance()
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof PeopleDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((PeopleDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new PeopleDomainNavigatorItem((EObject) objects[i],
