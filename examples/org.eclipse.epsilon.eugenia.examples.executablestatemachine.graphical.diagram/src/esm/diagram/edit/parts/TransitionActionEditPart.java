 ...
 * @generated
 */
public class TransitionActionEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				EsmVisualIDRegistry
						.getType(esm.diagram.edit.parts.TransitionActionEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public TransitionActionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new MachineEditPart.LinkLabelDragPolicy());
	}
