...
import esm.diagram.edit.policies.EsmTextSelectionEditPolicy;
 ...
 * @generated
 */
public class EndStateNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				EsmVisualIDRegistry
						.getType(esm.diagram.edit.parts.EndStateNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public EndStateNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new EsmTextSelectionEditPolicy());
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					EsmEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new EndStateLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EndStateLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EndStateLabelFigure() {
			this.setText("EndState");
		}
