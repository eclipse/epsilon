 ...
 * @generated
 */
public class EsmElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public EsmElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.EsmElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "esm".equals(fileExtension); //$NON-NLS-1$
	}
