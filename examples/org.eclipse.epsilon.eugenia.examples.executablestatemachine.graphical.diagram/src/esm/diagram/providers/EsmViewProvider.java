 ...
 * @generated
 */
public class EsmViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return MachineEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& EsmVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = EsmVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!EsmElementTypes.isKnownElementType(elementType)
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = EsmVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != EsmVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(MachineEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = EsmVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (EsmVisualIDRegistry.getVisualID(elementTypeHint)) {
	...
	public Node createState_2001(EObject domainElement, View containerView,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EsmVisualIDRegistry.getType(StateEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Edge createTransition_4001(EObject domainElement,
		...
		edge.setType(EsmVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		Node label6001 = createLabel(edge,
				EsmVisualIDRegistry.getType(TransitionActionEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!MachineEditPart.MODEL_ID.equals(EsmVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", MachineEditPart.MODEL_ID); //$NON-NLS-1$
