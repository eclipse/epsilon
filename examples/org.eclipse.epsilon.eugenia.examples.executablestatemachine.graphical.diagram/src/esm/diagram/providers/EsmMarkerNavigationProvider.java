...
import esm.diagram.part.EsmDiagramEditorUtil;

/**
 * @generated
 */
public class EsmMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = EsmDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			EsmDiagramEditorUtil.selectElementsInDiagram(editor,
