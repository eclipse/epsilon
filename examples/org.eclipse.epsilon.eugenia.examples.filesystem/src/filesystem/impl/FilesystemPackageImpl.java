...
public class FilesystemPackageImpl extends EPackageImpl implements FilesystemPackage {
	...
	public static FilesystemPackage init() {
		...
		FilesystemPackageImpl theFilesystemPackage = (FilesystemPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof FilesystemPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new FilesystemPackageImpl());
