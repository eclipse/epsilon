 ...
 * @generated
 */
public class DriveItemSemanticEditPolicy extends
		FilesystemBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public DriveItemSemanticEditPolicy() {
		super(FilesystemElementTypes.Drive_2001);
	}
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit
					...
					case Drive2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it
							...
							if (FilesystemVisualIDRegistry
									.getVisualID(incomingLink) == ShortcutTargetEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
					...
					case ShortcutEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							if (FilesystemVisualIDRegistry
									.getVisualID(outgoingLink) == ShortcutTargetEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
