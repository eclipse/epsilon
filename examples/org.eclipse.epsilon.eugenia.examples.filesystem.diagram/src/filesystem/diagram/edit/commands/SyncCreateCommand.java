 ...
 * @generated
 */
public class SyncCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final Filesystem container;

	/**
	 * @generated
	 */
	public SyncCreateCommand(CreateRelationshipRequest request, EObject source,
			EObject target) {
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof File) {
			return false;
		}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Sync newElement = FilesystemFactory.eINSTANCE.createSync();
		getContainer().getSyncs().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Sync newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
	 ...
	 * @generated
	 */
	private static Filesystem deduceContainer(EObject source, EObject target) {
