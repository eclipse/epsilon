 ...
 * @generated
 */
public class ShortcutEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ShortcutEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ShortcutItemSemanticEditPolicy());
	 ...
	 * @generated
	 */
	public ShortcutFigure getPrimaryShape() {
		return (ShortcutFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ShortcutNameEditPart) {
			((ShortcutNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureShortcutLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof filesystem.diagram.edit.parts.ShortcutEditPart) {
			types.add(FilesystemElementTypes.Sync_4001);
		}
	...
	public class ShortcutFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureShortcutLabelFigure;
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureShortcutLabelFigure() {
