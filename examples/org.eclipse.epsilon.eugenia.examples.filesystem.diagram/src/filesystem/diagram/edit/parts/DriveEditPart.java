 ...
 * @generated
 */
public class DriveEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DriveEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DriveItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DriveNameEditPart) {
			((DriveNameEditPart) childEditPart).setLabel(getPrimaryShape()
		...
		if (childEditPart instanceof DriveDriveContentsCompartmentEditPart) {
			...
			pane.add(((DriveDriveContentsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
