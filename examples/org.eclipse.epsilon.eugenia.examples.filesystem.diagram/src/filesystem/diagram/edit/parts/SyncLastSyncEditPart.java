...
import filesystem.diagram.edit.policies.FilesystemTextSelectionEditPolicy;
 ...
 * @generated
 */
public class SyncLastSyncEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				FilesystemVisualIDRegistry
						.getType(filesystem.diagram.edit.parts.SyncLastSyncEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public SyncLastSyncEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new FilesystemEditPart.LinkLabelDragPolicy());
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					FilesystemEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new SyncLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SyncLabelFigure extends WrappingLabel {
