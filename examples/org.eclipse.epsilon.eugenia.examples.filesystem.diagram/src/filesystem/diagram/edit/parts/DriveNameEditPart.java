 ...
 * @generated
 */
public class DriveNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DriveNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new FilesystemEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FilesystemParserProvider
					.getParser(
							FilesystemElementTypes.Drive_2001,
							getParserElement(),
							FilesystemVisualIDRegistry
									.getType(filesystem.diagram.edit.parts.DriveNameEditPart.VISUAL_ID));
		}
		return parser;
	}
