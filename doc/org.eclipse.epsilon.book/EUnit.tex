...
\begin{longtabu}{|p{6.5cm}|X|}
  ...
  assertMatchingLine(\parameter{[msg: String,]\parameter{path: String},\parameter{regexp: String}}) & Fails the test with the optional message it none of the lines of the file in \variable{path} match the regular expression \variable{regexp}\footnote{See \class{java.util.regex.Pattern} for details about the accepted syntax for regular expressions.}. \\\hline
