...
\begin{lstlisting}[float=tbp, caption=Exemplar context-defining EOL operations, label=lst:OperationsContext, language=EOL]
1.add1().add2().println();
...
\begin{lstlisting}[float=tbp, caption=Exemplar EOL context-less EOL operations, label=lst:OperationsNoContext, language=EOL]
add2(add1(1)).println();
...
\begin{lstlisting}[float=tbp, caption=Example illustrating an if statement, label=lst:IfStatement, language=EOL]
if (a > 0) {
...
\begin{lstlisting}[float=tbp, caption=Example illustrating a switch statement, label=lst:SwitchStatement1, language=EOL]
var i = "2";
...
\begin{lstlisting}[float=tbp, caption=Example illustrating falling through cases in a switch statement, label=lst:SwitchStatement2, language=EOL]
var i = "2";
...
\begin{lstlisting}[float=tbp, caption=Example of a while statement, label=lst:WhileStatement, numbers=left, language=EOL]
var i : Integer = 0;
while (i < 5) {
...
\begin{lstlisting}[float=tbp, caption=Example of a for statement, label=lst:ForStatement, language=EOL]
...
\begin{lstlisting}[float=tbp, caption=Example of the break\, breakAll and continue statements, label=lst:BreakStatement, language=EOL]
...
\begin{lstlisting}[float=tbp, caption=Example of the throw statement, label=lst:ThrowStatement, language=EOL]
throw 42;
throw "Error!";
\end{lstlisting}
...
\begin{lstlisting}[float=tbp, caption=Example of a for statement, label=lst:TransactionStatement, language=EOL]
...
\begin{lstlisting}[float=tbp, caption=Calculating and printing the depth of each Tree, label=lst:NoExtendedProperties, language=EOL]
