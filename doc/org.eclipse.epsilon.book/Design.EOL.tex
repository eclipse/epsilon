...
Also, EOL collections support the following first-order operations. Apart from \emph{aggregate} and \emph{closure}, all of these operations execute in parallel. It is therefore assumed that all invocations of these operations are free from side-effects.
