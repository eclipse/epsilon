...
%\makeatletter
%\g@addto@macro{\sidewaysfigure}{\PLS@Rotate{90}}
%\g@addto@macro{\endsidewaysfigure}{\PLS@Rotate{0}}
%\makeatother
\begin{document} 
...
\vspace{13cm}
\\
\large{Dimitris Kolovos, Louis Rose, Antonio Garc\'{\i}a-Dom\'{\i}nguez, Richard Paige, Sina Madani}
\end{center}
