...
public class MigrationModelsConfigurationTab extends ModelsConfigurationTab implements SelectionListener {
	...
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		...
		configuration.setAttribute(MigrationLaunchConfigurationAttributes.ORIGINAL_MODEL, originalCombo.getSelectionIndex());
		configuration.setAttribute(MigrationLaunchConfigurationAttributes.MIGRATED_MODEL, migratedCombo.getSelectionIndex());
	}
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		...
		try {
			originalCombo.select(configuration.getAttribute(MigrationLaunchConfigurationAttributes.ORIGINAL_MODEL, -1));
			migratedCombo.select(configuration.getAttribute(MigrationLaunchConfigurationAttributes.MIGRATED_MODEL, -1));
