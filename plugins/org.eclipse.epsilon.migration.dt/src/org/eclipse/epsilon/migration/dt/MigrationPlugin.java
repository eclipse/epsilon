 ...
 ******************************************************************************/
package org.eclipse.epsilon.migration.dt;
 ...
 */
public class MigrationPlugin extends AbstractUIPlugin implements EpsilonPlugin{
	...
	public Image createImage(String path) {
		try {
			URL BASE_URL = MigrationPlugin.getDefault().getBundle().getEntry("/");
