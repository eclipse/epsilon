...
public class EUnitOperationFactory extends OperationFactory {
	...
	protected void createCache() {
		super.createCache();
		final TreeEqualityAssertionOperation equalTreesOp
			= new TreeEqualityAssertionOperation(true);
		final TreeEqualityAssertionOperation nequalTreesOp
			= new TreeEqualityAssertionOperation(false);
