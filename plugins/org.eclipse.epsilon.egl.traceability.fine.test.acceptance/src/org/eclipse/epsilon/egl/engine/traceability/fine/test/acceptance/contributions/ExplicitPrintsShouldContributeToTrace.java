...
public class ExplicitPrintsShouldContributeToTrace extends EglFineGrainedTraceabilityAcceptanceTest {

	private static final String egl = "[% out.println(EClass.all.first.name); %]";
