 ...
 * ******************************************************************************
 *
 * $Id: BooleanSlotImpl.java,v 1.2 2008/07/30 11:13:02 dkolovos Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.emc.emf.virtual.impl.BooleanSlotImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanSlotImpl extends SlotImpl implements BooleanSlot {
	...
	protected EClass eStaticClass() {
		return VirtualPackage.Literals.BOOLEAN_SLOT;
	}
	...
	public EList<Boolean> getValues() {
		if (values == null) {
			values = new EDataTypeUniqueEList<Boolean>(Boolean.class, this, VirtualPackage.BOOLEAN_SLOT__VALUES);
		}
		return values;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VirtualPackage.BOOLEAN_SLOT__VALUES:
				return getValues();
		}
