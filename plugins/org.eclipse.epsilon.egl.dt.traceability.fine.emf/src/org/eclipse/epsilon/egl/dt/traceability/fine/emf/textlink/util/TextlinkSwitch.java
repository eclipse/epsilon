...
public class TextlinkSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TextlinkPackage.TRACE: {
				Trace trace = (Trace)theEObject;
				T result = caseTrace(trace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TextlinkPackage.TRACE_LINK: {
			...
			case TextlinkPackage.MODEL_LOCATION: {
				ModelLocation modelLocation = (ModelLocation)theEObject;
				T result = caseModelLocation(modelLocation);
				if (result == null) result = caseTraceLinkEnd(modelLocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TextlinkPackage.EMF_MODEL_LOCATION: {
				EmfModelLocation emfModelLocation = (EmfModelLocation)theEObject;
				T result = caseEmfModelLocation(emfModelLocation);
				if (result == null) result = caseModelLocation(emfModelLocation);
				if (result == null) result = caseTraceLinkEnd(emfModelLocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TextlinkPackage.TEXT_LOCATION: {
				TextLocation textLocation = (TextLocation)theEObject;
				T result = caseTextLocation(textLocation);
				if (result == null) result = caseTraceLinkEnd(textLocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TextlinkPackage.REGION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Trace Link End</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Trace Link End</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTraceLinkEnd(TraceLinkEnd object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Emf Model Location</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Emf Model Location</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEmfModelLocation(EmfModelLocation object) {
		return null;
	}
