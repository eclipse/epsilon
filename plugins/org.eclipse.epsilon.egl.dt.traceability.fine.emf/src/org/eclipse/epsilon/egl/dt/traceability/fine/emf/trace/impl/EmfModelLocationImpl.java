 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.egl.dt.traceability.fine.emf.trace.impl.EmfModelLocationImpl#getModelElement <em>Model Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EmfModelLocationImpl extends ModelLocationImpl implements EmfModelLocation {
	...
	protected EClass eStaticClass() {
		return TracePackage.Literals.EMF_MODEL_LOCATION;
	}
		...
		if (modelElement != null && modelElement.eIsProxy()) {
			...
			if (modelElement != oldModelElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TracePackage.EMF_MODEL_LOCATION__MODEL_ELEMENT, oldModelElement, modelElement));
			}
		}
		return modelElement;
	}
	...
	public void setModelElement(EObject newModelElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.EMF_MODEL_LOCATION__MODEL_ELEMENT, oldModelElement, modelElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TracePackage.EMF_MODEL_LOCATION__MODEL_ELEMENT:
