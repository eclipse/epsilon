 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.egl.engine.traceability.fine.trace.impl.ModelLocationImpl#getModelElement <em>Model Element</em>}</li>
 *   <li>{@link org.eclipse.epsilon.egl.engine.traceability.fine.trace.impl.ModelLocationImpl#getFeatureName <em>Feature Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ModelLocationImpl extends EObjectImpl implements ModelLocation {
	/**
		...
		if (modelElement != null && modelElement.eIsProxy()) {
			...
			if (modelElement != oldModelElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TracePackage.MODEL_LOCATION__MODEL_ELEMENT, oldModelElement, modelElement));
			}
		}
		return modelElement;
	}
	...
	public void setModelElement(EObject newModelElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.MODEL_LOCATION__MODEL_ELEMENT, oldModelElement, modelElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TracePackage.MODEL_LOCATION__MODEL_ELEMENT:
