...
public class TracePackageImpl extends EPackageImpl implements TracePackage {
	 ...
	 * @see org.eclipse.epsilon.egl.engine.traceability.fine.trace.TracePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getModelLocation_ModelElement() {
		return (EReference)modelLocationEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getModelLocation_FeatureName() {
		return (EAttribute)modelLocationEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(modelLocationEClass, MODEL_LOCATION__MODEL_ELEMENT);
	...
	public void initializePackageContents() {
		...
		initEReference(getModelLocation_ModelElement(), ecorePackage.getEObject(), null, "modelElement", null, 1, 1, ModelLocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
