...
public class ModelChoiceTab extends AbstractLaunchConfigurationTab implements ModifyListener{
	...
	public Image getImage() {
		return EtlPlugin.getDefault().createImage("icons/modelchoice.gif");
	}
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		...
		try {
			sourceCombo.setText(configuration.getAttribute(EtlLaunchConfigurationAttributes.SOURCE_MODEL, ""));
			targetCombo.setText(configuration.getAttribute(EtlLaunchConfigurationAttributes.TARGET_MODEL, ","));
	...
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(EtlLaunchConfigurationAttributes.SOURCE_MODEL, sourceCombo.getText());
		configuration.setAttribute(EtlLaunchConfigurationAttributes.TARGET_MODEL, targetCombo.getText());
	}
