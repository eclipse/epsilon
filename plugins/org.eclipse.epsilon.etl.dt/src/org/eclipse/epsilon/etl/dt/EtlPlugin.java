 ...
 */
public class EtlPlugin extends AbstractUIPlugin implements EpsilonPlugin{

	//The shared instance.
	private static EtlPlugin plugin;
	...
	public static ImageDescriptor getImageDescriptor(String path) {
		return AbstractUIPlugin.imageDescriptorFromPlugin("org.eclipse.epsilon.etl.dt", path);
	}
	...
	public Image createImage(String path) {
		try {
			URL BASE_URL = EtlPlugin.getDefault().getBundle().getEntry("/");
