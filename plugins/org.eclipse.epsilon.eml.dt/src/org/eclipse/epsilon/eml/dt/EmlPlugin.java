 ...
 */
public class EmlPlugin extends AbstractUIPlugin implements EpsilonPlugin{

	//The shared instance.
	private static EmlPlugin plugin;
	...
	public static ImageDescriptor getImageDescriptor(String path) {
		return AbstractUIPlugin.imageDescriptorFromPlugin("org.eclipse.epsilon.eml.dt", path);
	}
	...
	public Image createImage(String path) {
		try {
			URL BASE_URL = EmlPlugin.getDefault().getBundle().getEntry("/");
