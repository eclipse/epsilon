 ...
 * 
 * This class was extracted from the <code>org.eclipse.jdt.junit</code> project, also under
 * the EPL 1.0. We can't reuse it directly, as it is reserved for internal use, so we have
 * imported it into our codebase.
 */
