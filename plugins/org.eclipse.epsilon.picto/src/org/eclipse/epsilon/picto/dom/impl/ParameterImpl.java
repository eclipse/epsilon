...
public class ParameterImpl extends MinimalEObjectImpl.Container implements Parameter {
	...
	protected EClass eStaticClass() {
		return PictoPackage.Literals.PARAMETER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PictoPackage.PARAMETER__NAME, oldName, name));
	}
	...
	public void setValue(Object newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PictoPackage.PARAMETER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PictoPackage.PARAMETER__VALUE:
				return getValue();
			case PictoPackage.PARAMETER__VALUES:
				return getValues();
