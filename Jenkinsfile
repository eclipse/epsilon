            ...
            lock('download-area') {
              sshagent (['projects-storage.eclipse.org-bot-ssh']) {
                sh '''
                  ...
                  ssh genie.epsilon@projects-storage.eclipse.org 'rm -rf /home/data/httpd/download.eclipse.org/epsilon/interim-jars; rm -rf /home/data/httpd/download.eclipse.org/epsilon/interim-jars-unsigned; mkdir -p /home/data/httpd/download.eclipse.org/epsilon/interim-jars-unsigned; mkdir -p /home/data/httpd/download.eclipse.org/epsilon/interim-jars'
                  ...
                  ssh genie.epsilon@projects-storage.eclipse.org 'cd /home/data/httpd/download.eclipse.org/epsilon; for jar in $(ls interim-jars-unsigned/*.jar) do curl -o interim-jars/$jar -F file=interim-jars-unsigned/$jar http://build.eclipse.org:31338/sign done; rm -rf /home/data/httpd/download.eclipse.org/epsilon/interim-javadoc'
