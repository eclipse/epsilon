            ...
            lock('download-area') {
              sshagent (['projects-storage.eclipse.org-bot-ssh']) {
                sh '''
                  ...
                  ssh genie.epsilon@projects-storage.eclipse.org 'cd /home/data/httpd/download.eclipse.org/epsilon; for jar in $(ls interim-jars-unsigned/*.jar); do curl -o interim-jars/$jar -F file=interim-jars-unsigned/$jar "http://build.eclipse.org:31338/sign"; done'
